...
void OnImage()
{
	string sWorkingDir = "C:\\Users\\Katherine\\Documents\\ece588\\code";
	string imagename = "racket.bmp";

	string filename = "C:\\Users\\Katherine\\Documents\\ece588\\code\\reddetectionracket2.bmp";
	...
	namedWindow("Morph", WINDOW_AUTOSIZE);// Create a window for display.
	...
	Mat3b resultImage = image1.clone();
	yaed.DrawDetectedEllipses(resultImage, ellsYaed);


	namedWindow("Final Image", WINDOW_AUTOSIZE);// Create a window for display.
